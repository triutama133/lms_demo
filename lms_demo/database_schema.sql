...
-- Tambahkan setelah course_ratings
CREATE TABLE IF NOT EXISTS materials (
    ...
    "order" INTEGER,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    type TEXT NOT NULL DEFAULT 'markdown' CHECK (type IN ('pdf', 'markdown')),
    pdf_url TEXT,
    description TEXT
);
...
CREATE INDEX IF NOT EXISTS idx_materials_order ON materials("order");
