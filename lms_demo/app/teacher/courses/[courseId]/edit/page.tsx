        ...
        {loading ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex gap-2 justify-center">
              ...
              <button type="button" className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold px-4 py-2 rounded shadow transition-all" onClick={() => router.push('/teacher/courses/manage')}>Batal</button>
            </div>
          </form>
        )}
      </section>
