      ...
      <li ref={ref} className={`mb-4`} style={{ cursor: 'move', listStyle: 'none' }}>
        <div className={`flex items-center gap-3 p-4 bg-white border-2 rounded-xl shadow transition-all ${isDragging ? 'opacity-50 border-purple-400' : 'border-gray-200'}`}>
          ...
          <div className="flex gap-2">
            <Link href={`/teacher/courses/${courseId}/materials/${material.id}/view`} className="bg-green-100 hover:bg-green-200 rounded px-3 py-1 text-green-700 font-semibold text-sm transition-all">Lihat</Link>
            <Link href={`/teacher/courses/${courseId}/materials/${material.id}/edit`} className="bg-blue-100 hover:bg-blue-200 rounded px-3 py-1 text-blue-700 font-semibold text-sm transition-all">Edit</Link>
            <button
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 flex flex-col items-center px-4 pt-24">
        ...
        <div className="mb-6 text-center">
          <Link href={`/teacher/courses/${courseId}/materials/add`} className="bg-purple-600 hover:bg-purple-700 text-white font-semibold px-4 py-2 rounded shadow transition-all">Tambah Materi</Link>
        </div>
        {loading ? (
                    ...
                    <li key={m.id} className="mb-4 bg-white">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="mt-2 md:mt-0 flex gap-2">
                          <Link href={`/teacher/courses/${courseId}/materials/${m.id}/view`} className="bg-green-100 hover:bg-green-200 rounded px-3 py-1 text-green-700 font-semibold text-sm transition-all">Lihat</Link>
                          <Link href={`/teacher/courses/${courseId}/materials/${m.id}/edit`} className="bg-blue-100 hover:bg-blue-200 rounded px-3 py-1 text-blue-700 font-semibold text-sm transition-all">Edit</Link>
                          <button
                            className="bg-red-100 hover:bg-red-200 rounded px-3 py-1 text-red-700 font-semibold text-sm transition-all"
                            onClick={() => {
