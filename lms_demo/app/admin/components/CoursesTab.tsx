                ...
                <tr key={c.id} className="odd:bg-white even:bg-slate-50/80 hover:bg-fuchsia-50 transition">
                  ...
                  <td className="px-4 py-3 border-b border-slate-200">
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Link href={`/teacher/courses/${c.id}/materials`} className="rounded-lg bg-indigo-500 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-indigo-600">Kelola Materi</Link>
                    </div>
                  </td>
                </tr>
              ))
