        ...
        <main className="min-h-screen bg-gradient-to-b from-purple-50 via-white to-blue-100 px-4 pb-16">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 pt-28">
            <div className="rounded-3xl border border-red-200 bg-red-50 p-8 text-center">
              ...
              <Link href="/student/dashboard" className="mt-4 inline-block text-blue-600 hover:underline">
            ...
            <div className="grid gap-8 p-8 md:grid-cols-[1.6fr,1fr]">
              <div>
                ...
                <div className="mt-6 flex flex-col gap-3 md:flex-row md:items-center">
                  <Link href="/student/courses" className="rounded-xl bg-purple-600 px-5 py-2 text-sm font-semibold text-white shadow transition hover:bg-purple-700">Lanjutkan Course</Link>
                  <Link href="/student/materials" className="rounded-xl border border-purple-200 px-5 py-2 text-sm font-semibold text-purple-700 transition hover:bg-purple-50">Lihat Materi</Link>
                </div>
              </div>
            ...
            <div className="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-md">
              ...
              {progressData.length === 0 ? (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <Link href="/student/courses" className="mt-2 inline-block text-blue-600 hover:underline">
                    Jelajahi Course
                  </Link>
                </div>
              ) : (
