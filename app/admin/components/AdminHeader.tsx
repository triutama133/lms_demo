    ...
    <header className="w-full bg-gradient-to-r from-indigo-800 via-blue-700 to-purple-700 shadow-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <nav className="flex items-center gap-2">
          <Link href="/student/dashboard" className="mx-1 rounded-full px-3 py-1.5 text-sm font-medium text-indigo-100 transition hover:bg-white/10">Student</Link>
          <Link href="/teacher/dashboard" className="mx-1 rounded-full px-3 py-1.5 text-sm font-medium text-indigo-100 transition hover:bg-white/10">Teacher</Link>
