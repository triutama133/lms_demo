...
const SectionEditor = dynamic(() => import('../../../../../../app/components/SectionEditor'), { ssr: false });
        ...
        await new Promise<void>((resolve, reject) => {
          ...
          xhr.upload.onprogress = (event) => {
            if (event.lengthComputable) {
              // Progress handling bisa ditambahkan di masa depan
            }
          };
          xhr.onload = () => {
            setLoading(false);
      ...
      <section className="max-w-xl w-full bg-white/90 rounded-xl shadow-lg p-8 mt-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex gap-2 justify-end">
            <button type="button" className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold px-4 py-2 rounded" onClick={() => router.push(`/teacher/courses/${courseId}/materials`)}>Batal</button>
